...
* Rust
  * Glean-Core will no longer overwrite User-Agent, but instead send that information as X-Telemetry-Agent ([bug 1711928](https://bugzilla.mozilla.org/show_bug.cgi?id=1711928))
