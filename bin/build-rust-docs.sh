...
# General reference
mkdir -p build/docs/book/reference/general
echo '<meta http-equiv=refresh content=0;url=toggling-collection-status.html>' > build/docs/book/reference/general/toggling-upload-status.html
# Metrics API
