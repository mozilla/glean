...
Python can use the generated C header file directly, through [`cffi`](https://cffi.readthedocs.io/).
Re-generate it with
...
For Python this would be `glean-core/python/glean/metrics/counter.py`:
