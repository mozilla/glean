...
> **Note** Check out how this bucketing algorithm would behave on our [Histogram Simulator](../../appendix/histograms.html?kind=functional&data-options=log-normally-distributed&buckets-per-magnitude=8)
