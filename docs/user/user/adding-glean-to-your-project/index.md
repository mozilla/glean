...
##  Integration of Glean apps into GLAM
Go through [On-boarding Glean apps to GLAM](./glam.md) to understand the prerequisites that need to be considered to make Glean app available in GLAM.
