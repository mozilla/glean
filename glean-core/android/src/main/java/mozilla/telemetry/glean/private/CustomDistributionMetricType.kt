 ...
 */
class CustomDistributionMetricType : HistogramBase {
    lateinit var inner: CustomDistributionMetric
    ...
    constructor(
        ...
        Dispatchers.Delayed.launch {
            inner = CustomDistributionMetric(meta, rangeMin, rangeMax, bucketCount, histogramType)
        }
    }

    constructor(metric: CustomDistributionMetric) {
        inner = metric
    }
