...
class MemoryDistributionMetricType : HistogramBase {
    lateinit var inner: MemoryDistributionMetric

    constructor(meta: CommonMetricData, memoryUnit: MemoryUnit) {
        Dispatchers.Delayed.launch {
            inner = MemoryDistributionMetric(meta, memoryUnit)
        }
    }

    constructor(metric: MemoryDistributionMetric) {
        inner = metric
    }
