...
namespace Mozilla.Glean.Private
{
    ...
    /// </summary>
    public class PingType<ReasonCodesEnum> : PingTypeBase where ReasonCodesEnum : struct, System.Enum
    {
        ...
        /// </summary>
        /// <param name="reasonCode">The reason code enum for ping submit.</param>
        public void Submit(ReasonCodesEnum? reasonCode = null)
        {
            // TODO: submit pings
            //GleanInstance.SubmitPings()
        }
    }
}
