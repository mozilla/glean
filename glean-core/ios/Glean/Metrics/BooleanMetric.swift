...
///
/// The boolean API only exposes the `BooleanMetricType.set` method, which takes care of validating the input
...
public class BooleanMetricType {
    ...
    func testGetValue(_ pingName: String? = nil) throws -> Bool {
        Dispatchers.shared.assertInTestingMode()
