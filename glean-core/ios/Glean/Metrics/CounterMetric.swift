...
///
/// The counter API only exposes the `CounterMetricType.add` method, which takes care of validating the input
...
public class CounterMetricType {
    ...
    ///
    /// - paramaters:
    //      * amount: This is the amount to increment the counter by,
    //                defaulting to 1 if called without parameters.
