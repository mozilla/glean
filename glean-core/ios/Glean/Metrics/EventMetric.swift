...
///
/// For user-defined event metrics these will be defined as `enums`.
...
///
/// The Events API only exposes the `EventMetricType.record(_:)` method, which takes care of validating the input
