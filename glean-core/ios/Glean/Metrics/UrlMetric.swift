...
public class UrlMetricType {
    ...
    deinit {
        if self.handle != 0 {
            glean_destroy_url_metric(self.handle)
        }
    }
    ...
    public func set(_ value: String) {
        ...
        Dispatchers.shared.launchAPI {
            glean_url_set(self.handle, value)
        }
    }
    ...
    public func testHasValue(_ pingName: String? = nil) -> Bool {
        ...
        return glean_url_test_has_value(self.handle, pingName).toBool()
    }
    ...
    public func testGetValue(_ pingName: String? = nil) throws -> String {
        ...
        return String(freeingGleanString: glean_url_test_get_value(self.handle, pingName))
    }
    ...
    public func testGetNumRecordedErrors(_ errorType: ErrorType, pingName: String? = nil) -> Int32 {
        ...
        return glean_url_test_get_num_recorded_errors(
            self.handle,
            errorType.rawValue,
            pingName
        )
