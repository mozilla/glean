...
class EventMetricTypeTests: XCTestCase {
    ...
    func testEventSavesToStorage() {
        ...
        let metric = EventMetricType<ClickExtras>(
            CommonMetricData(
                category: "ui",
                name: "click",
                sendInPings: ["store1"],
        ...
        XCTAssertLessThanOrEqual(
            events[0].timestamp, events[1].timestamp, "The sequence of events must be preserved")
    }
    ...
    func testEventNotRecordedWhenDisabled() {
        let metric = EventMetricType<NoExtras>(
            CommonMetricData(
                category: "ui",
                name: "click",
                sendInPings: ["store1"],
    ...
    func testEventNotRecordWhenUploadDisabled() {
        let metric = EventMetricType<TestExtras>(
            CommonMetricData(
                category: "ui",
                name: "click",
                sendInPings: ["store1", "store2"],
    ...
    func testFlushQueuedEventsOnStartup() {
        ...
        let event = EventMetricType<SomeExtras>(
            CommonMetricData(
                category: "telemetry",
                name: "test_event",
                sendInPings: ["events"],
    ...
    func testEventListener() {
        let event1 = EventMetricType<SomeExtras>(
            CommonMetricData(
                category: "telemetry",
                name: "test_event1",
                sendInPings: ["events"],
        ...
        let event2 = EventMetricType<SomeExtras>(
            CommonMetricData(
                category: "telemetry",
                name: "test_event2",
                sendInPings: ["events"],
        ...
        let event3 = EventMetricType<SomeExtras>(
            CommonMetricData(
                category: "telemetry",
                name: "test_event3",
                sendInPings: ["events"],
