...
pub trait AllowLabeled: private::ToLabeled {}

// Implement the trait for everything we marked as allowed.
impl<T> AllowLabeled for T where T: private::ToLabeled {}
...
/// This implements the developer facing API for recording labeled metrics.
///
...
mod test {
    ...
    fn test_other_label_with_predefined_labels() {
        ...
        assert_eq!(3, metric.get("not_there").test_get_value(None).unwrap());
    }
