...
impl fmt::Debug for PingType {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.debug_struct("PingType")
            ...
            .field("uploader_cfg", &self.0.uploader_cfg)
            .finish()
    }
}
...
impl PingType {
    ...
    /// * `uploader_cfg` - The ordered list of capabilities this ping requires to be uploaded with.
    ...
    pub fn uploader_cfg(&self) -> &[String] {
        &self.0.uploader_cfg
    }
            ...
            Some(ping) => {
                ...
                if let Err(e) = ping_maker.store_ping(glean.get_data_path(), &ping) {
                    ...
                    let ping = PingPayload {
                        ...
                        uploader_cfg: self.0.uploader_cfg.clone(),
                    };
