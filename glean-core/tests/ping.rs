...
fn write_ping_to_disk() {
    ...
    let ping = PingType::new("metrics", true, false, true, true, vec![], true);
...
fn empty_pings_with_flag_are_sent() {
    ...
    let ping1 = PingType::new("custom-ping1", true, true, true, true, vec![], true);
    glean.register_ping_type(&ping1);
    let ping2 = PingType::new("custom-ping2", true, false, true, true, vec![], true);
...
fn test_pings_submitted_metric() {
    ...
    let metrics_ping = PingType::new("metrics", true, false, true, true, vec![], true);
    glean.register_ping_type(&metrics_ping);

    let baseline_ping = PingType::new("baseline", true, false, true, true, vec![], true);
...
fn events_ping_with_metric_but_no_events_is_not_sent() {
    ...
    let events_ping = PingType::new("events", true, true, true, true, vec![], true);
