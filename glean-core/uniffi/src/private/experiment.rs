...
use crate::private::{Metric, MetricType, RecordedExperiment};
use crate::storage::{self, INTERNAL_STORAGE};
...
impl ExperimentMetric {
    ...
    pub fn set_active(&self, glean: &Glean, branch: String, extra: HashMap<String, String>) {
