...
class ExperimentInfoTest: XCTestCase {
    ...
    // Test experiment info on pings
    //  - We launch the app
    //  - Set an experiment active through the experiment API
    //  - Put the app into background
    //  - Check pings for experiment annotations
    //  - Bring the app to foreground again
    //  - Check startup pings for experiment annotations
    //
    // There are three baseline pings we should receive:
    ...
    func testValidateExperimentInfo() {
